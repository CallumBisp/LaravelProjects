    ...
    <div class="grid grid-cols-2 gap-8">
        ...
        <div class="mb-4">
            ...
            <input 
                ...
                required
                class="mt-1 p-4 block w-full border-gray-300 bg-[#F0FFFF] rounded-md shadow-sm"
            />
        ...
        <div class="mb-4">
            ...
            <input
                ...
                id="image"
                {{isset($area) ? '' : 'required' }}
                class="mt-1 block w-full border-gray-300 bg-[#F0FFFF] rounded-md p-3.5 shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            />
            @error('image')
                <p class="text-sm text-red-600">{{ $message }}</p>
            @enderror
    ...
    <div class="grid grid-cols-2 gap-8">
        <div class="mb-4">
            ...
            <input 
                ...
                required
                class="mt-1 p-4 block w-full bg-[#F0FFFF] border-gray-300 rounded-md shadow-sm"
            />
            @error('connections')
                <p class="text-sm text-red-600">{{ $message }}</p>
            @enderror
